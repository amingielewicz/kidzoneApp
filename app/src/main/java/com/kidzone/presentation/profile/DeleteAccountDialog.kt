            ...
            Column {
                ...
                BulletLine(
                    text = "Twoje opinie ($reviewsCount) zostaną zanonimizowane — " +
                        "ich treść pozostanie, ale autor zmieni się na „Nieaktywny użytkownik""
                )
                BulletLine(
                ...
                Text(
                    text = "Treści tworzone przez Ciebie (opinie, miejsca, zdjęcia) " +
                        "stanowią wartość dla społeczności i pozostaną dostępne " +
                        "w formie zanonimizowanej (zgodnie z RODO).",
